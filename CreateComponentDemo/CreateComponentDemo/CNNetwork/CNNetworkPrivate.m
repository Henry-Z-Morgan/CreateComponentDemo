...
void CNLog(NSString *format, ...) {
#ifdef DEBUG
    if (![CNNetworkConfig sharedConfig].debugLogEnabled) {
        return;
    }
    va_list argptr;
...
+ (void)addDoNotBackupAttribute:(NSString *)path {
    ...
    if (error) {
        CNLog(@"error to set do not backup attribute, error = %@", error);
    }
}
...
@implementation CNBaseRequest (RequestAccessory)

- (void)toggleAccessoriesWillStartCallBack {
    for (id<CNRequestAccessory> accessory in self.requestAccessories) {
...
@implementation CNBatchRequest (RequestAccessory)
...
@implementation CNChainRequest (RequestAccessory)
