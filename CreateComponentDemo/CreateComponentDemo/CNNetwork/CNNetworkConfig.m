...
@implementation CNNetworkConfig {
    NSMutableArray<id<CNUrlFilterProtocol>> *_urlFilters;
    NSMutableArray<id<CNCacheDirPathFilterProtocol>> *_cacheDirPathFilters;
}
...
- (NSArray<id<CNUrlFilterProtocol>> *)urlFilters {
    return [_urlFilters copy];
}

- (NSArray<id<CNCacheDirPathFilterProtocol>> *)cacheDirPathFilters {
